...
const ExploreStates = () => {
  ...
  // 👇 YOUR CURATED IMAGE LIST
  // Note: This order MUST match the alphabetical order of states returned by the library.
  const stateImages = [
    "https://www.indiantempletour.com/wp-content/uploads/2022/08/Andaman-and-Nicobar-Islands-Package-1.jpg", // Andaman & Nicobar
    "https://etimg.etb2bimg.com/photo/89314482.cms", // Andhra Pradesh
    "https://static.toiimg.com/thumb/91692790/Arunachal-Dirang-Monastery.jpg?width=1200&height=900", // Arunachal Pradesh
    "https://www.kaziranganationalpark-india.com/blog/wp-content/uploads/2025/04/majuli-island.jpg", // Assam
    "https://upload.wikimedia.org/wikipedia/commons/d/dd/Temple_No.-_3%2C_Nalanda_Archaeological_Site.jpg", // Bihar
    "https://chandigarhtourism.in/images/places-to-vist/headers/chandigarh-local-sightseeing-tour-packages-header-chandigarh-tourism.jpg.jpg", // Chandigarh
    "https://portal-tourism.cgstate.gov.in/files/Chitrakote%20Waterfall(1).JPG", // Chhattisgarh
    "https://s7ap1.scene7.com/is/image/incredibleindia/2-diu-fort-diu-attr-hero-1?qlt=82&ts=1726737809175", // Dadra & Nagar Haveli...
    "https://static.toiimg.com/photo/msid-88070906,width-96,height-65.cms", // Delhi
    "https://images.financialexpressdigital.com/2024/01/goa-tourism.jpg", // Goa
    "https://www.gujarattourism.com/content/dam/gujrattourism/images/home_page/SOU.jpg", // Gujarat
    "https://haryanatourism.gov.in/wp-content/uploads/2024/06/KURUKSHETRA.jpg", // Haryana
  ...
  useEffect(() => {
    // 1. Get states (this usually returns them in alphabetical order)
    const indiaStates = State.getStatesOfCountry('IN');
    
    // 2. Duplicate list for "endless" scroll feel
    const infiniteList = [...indiaStates, ...indiaStates, ...indiaStates];
    setStates(infiniteList);
  }, []);
  ...
  return (
    <section style={{ position: 'relative', padding: '60px 0', backgroundColor: '#f9fafb' }}>
      ...
      <button 
        onClick={() => scroll('left')}
        style={{
          position: 'absolute', left: '20px', top: '55%', transform: 'translateY(-50%)', zIndex: 10,
          backgroundColor: 'white', border: '1px solid #e5e7eb', borderRadius: '50%',
      ...
      <button 
        onClick={() => scroll('right')}
        style={{
          position: 'absolute', right: '20px', top: '55%', transform: 'translateY(-50%)', zIndex: 10,
          backgroundColor: 'white', border: '1px solid #e5e7eb', borderRadius: '50%',
          width: '50px', height: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center',
          cursor: 'pointer', boxShadow: '0 4px 6px rgba(0,0,0,0.1)'
        }}
      ...
      <div 
        ...
        style={{
          ...
          scrollSnapType: 'x mandatory', padding: '20px 60px',
      ...
      >
        {states.map((state, index) => (
          <div 
            key={`${state.isoCode}-${index}`}
            // 👇 CRITICAL: Navigates to /place/RJ, which matches our new App structure
            onClick={() => navigate(`/place/${state.isoCode}`)}
            style={{
          ...
          >
            ...
            <div style={{ height: '180px', backgroundColor: '#f3f4f6' }}>
              <img 
                // Matches image to state index (safely looping)
                src={stateImages[index % stateImages.length]}
                alt={state.name}
                style={{ width: '100%', height: '100%', objectFit: 'cover' }}
            ...
            <div style={{ padding: '20px' }}>
              ...
              <button style={{
                ...
                backgroundColor: '#f0fdf4', color: '#16a34a', fontSize: '13px',
